...
{
	private JLabel welcomeLabel,nameLabel,phnLabel,changePasswordLabel,idLabel;
	...
	{
		super("Bank Management System - Add Employee Window");
	...
	public void insert(String names, String phone,String pass,String Id)
	{
		double d=0.00;
		int status=0;
		String query = "INSERT INTO employee VALUES ('"+Id+"','"+names+"','"+phone+"' , "+d+");";
